...
?>
	<div id="main">
		...
		<?php
			$sign_orginal = strtoupper('d747829c984982e81fcd3bb515831cd7yuzhestudios@gmail.com4345'. $s .'CNYhttp://yuzhestudios.com/cart.php11');
			echo $sign_orginal. '<br>';
			$sign_hash = md5($sign_orginal);
			echo $sign_hash. '<br>';
		?>
		<form action="https://yoopay.cn/yapi" method="POST">
			...
			<input type="submit" value="YooPay">
		</form>
	</div>
