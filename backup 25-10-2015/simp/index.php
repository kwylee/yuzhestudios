    ...
    <div id="section2" class="section clearfix">
      <div class="intro">
        ...
        <p>工作室的创意是由毕业于伦敦时装学院，时尚面料设计专业的孙羽喆指导</p>
        <p>工作室的四个主要理念：
      </div>
      <div class="about-block">
        <h1>为“中国制造”而自豪</h1>
        <p>我们致力于改变对“中国制造”的负面成见。中国历史上有许多原创和概念 - 我们希望把这些中国的元素用于我们的工作室。</p>
      </div>
      
      <div class="about-block">
        <h1>独特的手工制作工艺与设计</h1>
        <p>我们自己的工作室有手工技术精湛的裁缝师。我们将独特的、现代的和与众不同的细节与传统手工艺结合在一起。我们将采用最优质的面料和材料。</p>
      </div>
