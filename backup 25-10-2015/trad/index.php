    ...
    <div id="section2" class="section clearfix">
      <div class="intro">
        Yuzhe Studios 是一個位於中國上海的獨立時裝設計工作室
        <p>工作室的創意是由畢業於倫敦時裝學院，時尚面料設計專業的孫羽喆指導</p>
        <p>工作室的四個主要理念：
      </div>
      <div class="about-block">
        <h1>為“中國製造”而自豪</h1>
        <p>我們致力於改變對“中國製造”的負面成見。中國歷史上有許多原創和概念- 我們希望把這些中國的元素用於我們的工作室。</p>
      </div>
      
      <div class="about-block">
        <h1>獨特的手工製作工藝與設計</h1>
        <p>我們自己的工作室有手工技術精湛的裁縫師。我們將獨特的、現代的和與眾不同的細節與傳統手工藝結合在一起。我們將採用最優質的面料和材料。</p>
      </div>

      <div class="about-block">
        <h1>經久不衰的設計</h1>
        <p>我們不會追逐別人最新的流行趨勢。新的成衣設計是由之前的設計演變發展而來。我們對自己的產品充滿自信，我們在自己的零售渠道沒有折扣。</p>
      </div>
