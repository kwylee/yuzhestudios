<?php
    ...
    <div id="section2" class="section clearfix">
       <div class="intro">
        Yuzhe Studios is an independent fashion studio based in Shanghai, China
        <p>The studio is creatively directed by Yuzhe Sun, a fashion textile graduate from London College of Fashion</p>
        <p>4 key ideas at the studio: 
      </div>
