...
?>    
    ...
    <div id="section2" class="section clearfix">
      <div class="intro">
        Yuzhe Studios 是一个位于中国上海的独立时装设计工作室 
        <p>工作室的创意是由毕业于伦敦时装学院，时尚面料设计专业的孙羽喆创意指导</p>
        <p>工作室的四个主要理念：</p>
      </div>
      <div class="about-block">
        <h1>为“中国制造”而自豪</h1>
        <p>我们致力于改变对“中国制造”的成见。中国历史有许多原创和理念 - 我们希望我们的工作室把这些中国的元素重现于人们的生活中。</p>
      </div>
      
      <div class="about-block">
        <h1>独特多元的设计与手工制作工艺</h1>
        <p>我们自己的工作室有手工技术精湛的裁缝师。我们将独特的、现代的和与众不同的设计细节与传统的手工艺结合在一起。我们会采用最优质的面料和材料。</p>
      </div>

      <div class="about-block">
        <h1>经久不衰的设计</h1>
        <p>我们不会追逐别人最新的流行趋势。新的成衣设计是由之前的设计演变发展而来。因为我们对自己的产品充满自信，所以我们在自己的零售渠道没有折扣。</p>
      </div>
